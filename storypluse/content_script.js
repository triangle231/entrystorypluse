    ...
    for (let i = 0; i < links.length; i++) {
      ...
      if (links[i].textContent.startsWith("https://www.youtube.com/watch?v=")) {
        if (links[i].getAttribute('data-iframe-loaded2') === null) {
          ...
          links[i].textContent = "들어가기";
          links[i].innerHTML += '<br><iframe width="560" height="315" src="' + links[i].href.replace("watch?v=", "embed/") + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe><br>'
